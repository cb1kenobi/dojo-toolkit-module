dojo.hostenv.packageLoaded({depends:[["provide", "drupal.widget.GoogleMapKeyTable"], ["require", "dojo.event.*"], ["require", "dojo.string.common"], ["require", "dojo.widget.*"], ["require", "dojo.widget.HtmlWidget"]], definePackage:function (dojo) {
