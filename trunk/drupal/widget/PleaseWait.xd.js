dojo.hostenv.packageLoaded({depends:[["provide", "drupal.widget.PleaseWait"], ["require", "dojo.event.*"], ["require", "dojo.widget.*"], ["require", "dojo.widget.HtmlWidget"], ["require", "dojo.widget.Dialog"]], definePackage:function (dojo) {
