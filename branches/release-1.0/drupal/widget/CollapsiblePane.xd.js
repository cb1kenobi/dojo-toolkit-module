dojo.hostenv.packageLoaded({depends:[["provide", "drupal.widget.CollapsiblePane"], ["require", "dojo.event.*"], ["require", "dojo.lfx.*"], ["require", "dojo.widget.*"], ["require", "dojo.widget.HtmlWidget"]], definePackage:function (dojo) {
